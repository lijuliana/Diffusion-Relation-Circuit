...
% ICML 2026 style file (blind-review version by default)
\usepackage{icml2026}
% For preprint:  \usepackage[preprint]{icml2026}
% For accepted:  \usepackage[accepted]{icml2026}
...
\icmltitlerunning{Head-Level Spatial-Binding Circuit in a Diffusion Transformer}

\begin{document}

\twocolumn[
\icmltitle{A Two-Stage Cross-Attention Circuit for Spatial-Relation Binding\\
in Small Diffusion Transformers}

\icmlsetsymbol{equal}{*}

\begin{icmlauthorlist}
\icmlauthor{Juliana Li}{harvard}
\icmlauthor{Binxu Wang}{harvard}
\end{icmlauthorlist}
...
\icmlkeywords{Diffusion Transformer, Mechanistic Interpretability, Cross-Attention, Spatial Binding, Circuit Analysis}
